...
const SERVICES = [
  {
    title: 'Putkiasennus',
    description: 'Ammattitaitoiset putkiasennukset ja -saneeraukset. Huolellista työtä alusta loppuun.',
    icon: Droplets,
    color: 'bg-teal-50 text-teal-600',
    tags: ['Uudiskohteet', 'Remontit', 'Hanojen vaihto']
  },
  {
    title: 'LVI-huolto',
    description: 'Ennakoiva huolto ja korjaukset. Pidämme kotisi tekniikan kunnossa.',
    icon: Wrench,
    color: 'bg-emerald-50 text-emerald-600',
    tags: ['Vianhaku', 'Tiivistykset', 'Patterit']
  },
  {
    title: 'Lämpöpumput',
    description: 'Ilmalämpöpumppujen ja vesi-ilmalämpöpumppujen asennus ja huolto.',
    icon: Thermometer,
    color: 'bg-green-50 text-green-600',
    tags: ['Energisäästö', 'Asennus', 'Huoltopesu']
  }
];
...
const REVIEWS = [
  {
    ...
    date: 'Tammikuu 2026',
    rating: 5,
    text: 'Nopeaa ja asiantuntevaa palvelua Lohjalla. Putkivuoto saatiin kuriin hetkessä.',
    source: 'Asiakaspalaute'
  },
  {
    name: 'Sari J.',
    date: 'Maaliskuu 2026',
    rating: 5,
    text: 'Ilmalämpöpumpun huolto hoitui sovittuna aikana ja jälki oli siistiä. Suosittelen!',
    source: 'Asiakaspalaute'
  },
  {
    name: 'Tuomas L.',
    date: 'Huhtikuu 2026',
    rating: 5,
    text: 'Rehellinen ja suoraselkäinen asenne. Hinta oli juuri se mitä sovittiin.',
    source: 'Asiakaspalaute'
  }
];
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <AnimatePresence>
        {showToast && (
          <motion.div
            ...
            className="fixed bottom-32 md:bottom-12 left-1/2 -translate-x-1/2 z-[100] bg-brand-primary text-white px-6 py-4 rounded-2xl shadow-2xl flex items-center gap-3 border border-white/10 backdrop-blur-xl"
          >
      ...
      <div className="bg-slate-900 text-white py-2 px-6">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center text-[10px] md:text-xs font-medium tracking-wider uppercase">
          <div className="flex gap-4 md:gap-6 items-center flex-wrap justify-center sm:justify-start">
            <a href="tel:+358400529491" className="flex items-center gap-1.5 hover:text-emerald-400 transition-colors">
              <Phone size={12} fill="currentColor" /> 040 052 9491
            </a>
            <div className="flex items-center gap-1.5 text-emerald-400">
              <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
              Vastaamme nyt: <span className="font-bold">~15 min</span>
            </div>
            <a href="mailto:antti.putkinurmi@gmail.com" className="flex items-center gap-1.5 hover:text-emerald-400 transition-colors">
              <Mail size={12} /> antti.putkinurmi@gmail.com
            </a>
          </div>
          <div className="hidden lg:flex gap-6 items-center">
            <div className="flex items-center gap-1.5 text-slate-400">
              <Clock size={12} /> 2h vastaustakuu
            </div>
            <div className="flex items-center gap-1.5 text-slate-400">
              <MapPin size={12} /> Palvelemme: Lohja, Vihti & Etelä-Suomi
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-2xl font-bold tracking-tight font-display">
              Putki<span className="text-brand-accent">Nurmi</span>
            </span>
          </div>
      ...
      <main>
        ...
        <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-slate-900">
          ...
          <div className="section-padding relative z-10 w-full flex justify-center">
            <motion.div
              ...
              className="max-w-4xl text-center text-white flex flex-col items-center"
            >
              ...
              <h1 className="text-5xl md:text-7xl font-bold leading-tight mb-6">
                PutkiNurmi – Rehellistä <span className="text-brand-accent">LVI-palvelua</span> ja laatua.
              </h1>

              <p className="text-xl text-slate-300 mb-10 leading-relaxed max-w-2xl">
                Lohjan ja Etelä-Suomen asiantuntevin LVI-huolto. Puhdasta jälkeä, jota kelpaa nurmella katsella koko Etelä-Suomen alueella.
              </p>
        ...
        <section className="bg-slate-50 py-24">
          <div className="section-padding grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <h3 className="text-4xl md:text-5xl font-bold mb-8">Uuden sukupolven LVI-osaamista Etelä-Suomessa</h3>
              ...
              <div className="space-y-8">
                {[
                  ...
                  },
                  {
                    ...
                    desc: 'Tunnemme Lohjan ja Etelä-Suomen talot ja niiden tekniikan. Olemme naapurisi, emme vain kasvoton aliurakoitsija.',
                    icon: MapPin
                  },
                  {
                    title: 'Nopea reagointi',
                    desc: 'Vastaamme tiedusteluihin mahdollisimman pian. Meidät saa kiinni silloin kun tarve on suurin.',
                    icon: Clock
                  }
                ].map((item, idx) => (
          ...
          <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-16 items-center">
            <div className="order-2 lg:order-1">
              ...
              <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                Alla oleva kuva kertoo enemmän kuin tuhat sanaa. Vasemmalla tyypillinen saneerauskohde ennen työtämme, oikealla PutkiNurmi-asennus. Panostamme siisteyteen, turvallisuuteen ja tekniseen kestävyyteen.
              </p>
            ...
            <div className="order-1 lg:order-2 relative flex justify-center lg:justify-end">
              <div className="rounded-[2.5rem] overflow-hidden shadow-2xl border-8 border-slate-50 max-w-sm lg:max-w-md">
                <img
                  ...
                  alt="Vertailukuva LVI-asennuksesta ennen ja jälkeen PutkiNurmi-huollon"
                  width={600}
                  height={800}
                  loading="lazy"
                  className="w-full h-full object-cover"
        ...
        <section id="meista" className="section-padding grid lg:grid-cols-2 gap-16 items-center border-b border-slate-100 scroll-mt-24">
          <div>
            ...
            <div className="space-y-4 text-slate-600 text-lg leading-relaxed">
              <p>
                Perustimme PutkiNurmi LVI-palvelut, koska uskomme että laatu ja luottamus ovat alan tärkeimmät arvot.
              </p>
              <p>
                Nimi PutkiNurmi viittaa työmme siisteyteen – jätämme kohteen aina asuinympäristöön sopivaan, viimeisteltyyn kuntoon.
              </p>
              <div className="pt-6">
                <div className="font-bold text-brand-primary text-xl">Antti PutkiNurmi</div>
                <div className="text-sm text-slate-500 font-bold uppercase tracking-widest">Yrittäjä & LVI-asentaja</div>
              </div>
            </div>
          </div>
          <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
               <div className="bg-white/90 backdrop-blur-lg px-10 py-5 rounded-[2rem] text-brand-primary text-xl font-bold shadow-2xl border border-white transform -rotate-1">
                 📸 Tähän haluamasi kuva
               </div>
            </div>
        ...
        <section className="bg-brand-primary text-white py-24 overflow-hidden relative">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <div className="space-y-6 bg-white/5 p-8 rounded-3xl border border-white/10 backdrop-blur-sm relative">
                  {isCalculating && (
                    <div className="absolute inset-0 bg-brand-primary/40 backdrop-blur-md z-20 flex items-center justify-center rounded-3xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {PRICING.map((item, idx) => (
              <div key={idx} className="bg-white border border-slate-200 rounded-3xl p-8 flex flex-col">
                ...
                <div className="text-3xl font-bold text-brand-primary mb-6">{item.price} <span className="text-sm font-normal text-slate-500">sis. alv 25,5%</span></div>
          ...
          <div className="mt-12 grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200">
              ...
              <ul className="space-y-3 text-slate-600">
                <li className="flex justify-between"><span>Huoltoautomaksu (sis. 20km)</span> <span className="font-bold">x €</span></li>
                <li className="flex justify-between"><span>Pientarvikelisä</span> <span className="font-bold">x €</span></li>
              ...
              {[
                {
                  ...
                  a: "Sulje välittömästi asunnon päävesihana. Jos kyseessä on kerrostalo, ota yhteys huoltoyhtiöön. Soita sitten meille numeroon 040 052 9491 – olemme paikalla nopeasti."
                },
                {
                    ...
                    {openFaq === idx && (
                      ...
                      >
                        <div className="px-6 pb-6 text-slate-600 leading-relaxed">
                          <span className="font-bold text-brand-primary" aria-hidden="true">A:</span> {faq.a}
                        </div>
                      </motion.div>
                    )}
                  </AnimatePresence>
          ...
          <div className="section-padding">
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
              ...
              <div className="flex items-center gap-4 bg-white/10 p-4 rounded-2xl backdrop-blur-sm border border-white/20">
                <div className="text-right">
                  <div className="text-2xl font-bold">100%</div>
                  <div className="text-sm text-slate-300">Asiakastyytyväisyys</div>
                </div>
              </div>
            </div>
                ...
                >
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input id="form-name" required type="text" className="w-full px-6 py-4 rounded-xl border border-slate-200 focus:border-brand-accent focus:ring-2 focus:ring-brand-accent/20 outline-none transition-all text-lg" placeholder="Matti Meikäläinen" />
                    </div>
                    <div className="space-y-2">
                      <label htmlFor="form-phone" className="text-sm font-bold uppercase tracking-wider text-slate-500">Puhelin</label>
                      <input id="form-phone" required type="tel" className="w-full px-6 py-4 rounded-xl border border-slate-200 focus:border-brand-accent focus:ring-2 focus:ring-brand-accent/20 outline-none transition-all text-lg" placeholder="040 123 4567" />
                    </div>
                  </div>
                  <div className="space-y-2">
                    <label htmlFor="form-email" className="text-sm font-bold uppercase tracking-wider text-slate-500">Sähköposti</label>
                    <input id="form-email" required type="email" className="w-full px-6 py-4 rounded-xl border border-slate-200 focus:border-brand-accent focus:ring-2 focus:ring-brand-accent/20 outline-none transition-all text-lg" placeholder="matti@esimerkki.fi" />
                  </div>
                  <div className="space-y-2">
                    <label htmlFor="form-message" className="text-sm font-bold uppercase tracking-wider text-slate-500">Miten voimme auttaa?</label>
                    <textarea id="form-message" required rows={4} className="w-full px-6 py-4 rounded-xl border border-slate-200 focus:border-brand-accent focus:ring-2 focus:ring-brand-accent/20 outline-none transition-all text-lg" placeholder="Kerro lyhyesti tarpeestasi..."></textarea>
                  </div>
                  <button
              ...
              <div className="bg-slate-900 p-12 md:p-16 text-white flex flex-col justify-between relative overflow-hidden">
                  ...
                  <div className="space-y-8">
                    <div className="flex gap-6">
                      ...
                      <div>
                        ...
                        <div className="text-xl font-bold">040 052 9491</div>
                      </div>
                    </div>
                    <div className="flex gap-6">
                      <div className="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center text-brand-accent">
                      ...
                      <div>
                        ...
                        <div className="text-base sm:text-lg md:text-xl font-bold break-all sm:break-normal">antti.putkinurmi@gmail.com</div>
                      </div>
                    </div>
                    <div className="flex gap-6">
                      <div className="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center text-brand-accent">
                      ...
                      <div>
                        ...
                        <div className="text-xl font-bold">Saukkolantie 822, 08500 Lohja</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-16 pt-16 border-t border-white/10 relative z-10">
                  ...
                  <p className="text-slate-400 text-sm">
                    Antti PutkiNurmi LVI on lohjalainen alan ammattilainen, joka panostaa rehellisyyteen ja tarkkaan työnjälkeen koko Etelä-Suomen alueella.
                  </p>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-slate-50 border-t border-slate-200 py-12">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="text-slate-500 text-sm">
            © 2026 Antti PutkiNurmi. Kaikki oikeudet pidätetään.
          </div>
      ...
      <div className="md:hidden fixed bottom-6 left-6 right-6 z-40">
        <a href="tel:+358400529491" className="btn-primary w-full py-4 shadow-2xl flex items-center justify-center gap-3">
